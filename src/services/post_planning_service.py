...
class PostPlanningService:
    ...
    def __init__(
        ...
        self.ai_client = ai_client	# AI client for generating post drafts
    ...
    def generate_posts(self, plan_id: int) -> List[PlannedPostRead]:
        ...
        try:
            ...
            logger.info(f"Received {len(drafts)} drafts from AI client for plan_id={plan_id}")
        ...
        for text in drafts:
            try:
                ...
                # Decide whether to continue or raise — here continuing to collect what can be created
